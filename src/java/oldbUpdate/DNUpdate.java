...
public class DNUpdate {
    ...
    public void addEntry(Connection con, String refNo) throws SQLException {
        ...
        String sql = "select * from DNCNHD where ref_no='" + refNo + "'";
        PreparedStatement pstLocal = con.prepareStatement(sql);
        ResultSet rsLocal = pstLocal.executeQuery();
        if (rsLocal.next()) {
            Date chq_date = rsLocal.getDate("VDATE");
            ...
            sql = "select * from DNCNDT where ref_no='" + refNo + "'";
            ...
            while (rsLocal.next()) {
                ...
                if (!rsLocal.getString("DOC_REF_NO").equalsIgnoreCase("")) {
                    ...
                    pstUpdate = con.prepareStatement(sqlUpdate);
                    pstUpdate.setDouble(1, rsLocal.getDouble("BAL") * -1);
                    ...
                    if (rec_no == -1) {
                        ...
                        pstUpdate.setString(2, "DN");
                        pstUpdate.setString(3, "0");
                        pstUpdate.setDate(4, chq_date);
                        pstUpdate.setString(5, ac_cd);
                        pstUpdate.setDouble(6, rsLocal.getDouble("BAL"));
                        pstUpdate.setDouble(7, rsLocal.getDouble("BAL"));
