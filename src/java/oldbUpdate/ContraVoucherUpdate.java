 ...
 * @author nice
 */
public class ContraVoucherUpdate {

    Library lb = null;
    String dbName = null;
    String companyName = null;

    public ContraVoucherUpdate() {
        lb = new Library();
    }

    public void addEntry(Connection con, String refNo) throws SQLException {
        int i = 0;
        String sql = "select * from CONTRAHD where ref_no='" + refNo + "'";
        ...
        if (rsLocal.next()) {
            ...
            sql = "select * from CONTRADT where ref_no='" + refNo + "'";
