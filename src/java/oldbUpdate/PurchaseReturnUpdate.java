...
public class PurchaseReturnUpdate {
    ...
    public PurchaseReturnUpdate() {
    }

    public void addEntry(Connection con, String refNo) throws SQLException {
        int i = 0;

        String sql = "select * from PRHD where ref_no='" + refNo + "'";
        ...
        if (rsLocal.next()) {
            ...
            sql = "select * from PRDT where ref_no='" + refNo + "'";
            ...
            pstUpdate.setString(2, clSysEnv.getPurchase_return_ac());
            i += pstUpdate.executeUpdate();
            ...
            pstUpdate.setDate(2, date);
            pstUpdate.setString(3, "PR");
            pstUpdate.setString(4, clSysEnv.getPurchase_return_ac());
            ...
            pstUpdate.setString(6, "0");
            pstUpdate.setString(7, "");
            pstUpdate.setString(8, clSysEnv.getPurchase_return_ac());
            pstUpdate.setTimestamp(9, ts);
            pstUpdate.setString(10, inv_no);
            i += pstUpdate.executeUpdate();
