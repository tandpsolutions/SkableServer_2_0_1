 ...
 * @author nice
 */
public class DCInwardUpdate {

    Library lb = null;
    SysEnv clSysEnv;

    public DCInwardUpdate() {
    ...
    public void addEntry(Connection con, String refNo) throws SQLException {
        ...
        if (rsLocal.next()) {
            ...
            while (rsLocal.next()) {
                ...
                sqlUpdate = "update oldb0_1 set PPUR_" + (date.getMonth() + 1) + "=PPUR_" + (date.getMonth() + 1) + "+? where SR_CD=?";
                pstUpdate = con.prepareStatement(sqlUpdate);
