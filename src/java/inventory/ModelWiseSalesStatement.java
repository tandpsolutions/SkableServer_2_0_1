 ...
 * @author bhaumik
 */
public class ModelWiseSalesStatement extends HttpServlet {
        ...
        if (dataConnection != null) {
            try {
                ...
                String sql = "SELECT m.MODEL_NAME,SUM(pcs) as QTY,SUM(rate) as PURCHASE,SUM(rate)/SUM(pcs) as AVG,MONTHNAME(o.DOC_DATE) as month "
                        + " FROM oldb0_2 o LEFT JOIN seriesmst s ON o.SR_CD=s.SR_CD LEFT JOIN modelmst m ON m.MODEL_CD=s.MODEL_CD WHERE TRNS_ID='I' "
