 ...
 * @author bhaumik
 */
public class IMEISearch extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dataConnection != null) {
            try {
                String sql = "select tag_no,s.sr_name from tag t left join seriesmst s on t.sr_cd=s.sr_cd where is_del <> -1 "
                        + " and tag_no like '%" + tag_no + "%'";
