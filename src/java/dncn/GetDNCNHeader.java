 ...
 * @author bhaumik
 */
public class GetDNCNHeader extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dataConnection != null) {
            try {
                String sql = "select c.AC_CD,c.REF_NO,VDATE,a.FNAME,c1.BAL,c1.REMARK,a1.fname as our_bank from dncnhd c left join dncndt c1 on c.ref_no=c1.ref_no"
                        + "  left join ACNTMST a on c.AC_CD=a.AC_CD"
                        + " left join acntmst a1 on a1.ac_cd=c.bank_cd where VDATE>=? and VDATE<=? and CTYPE=? and branch_cd=? order by VDATE,ref_no";
