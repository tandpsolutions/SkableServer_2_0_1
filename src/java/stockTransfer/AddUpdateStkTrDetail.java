...
import oldbUpdate.StkTransferUpdate;
    ...
    private JsonObject saveVoucher(final ArrayList<StockTransferDetail> detail) {
        ...
        if (dataConnection != null) {
            try {
                ...
                String sql = "";
                sql = "INSERT INTO stktrfhd (inv_no,V_DATE,from_loc,to_loc,USER_ID,REF_NO) VALUES (?,?,?,?,?,?)";
                detail.get(0).setRef_no(lb.generateKey(dataConnection, "stktrfhd", "REF_NO", "LENGTH(ref_no) >8 and REF_NO", "STTR", 11));
                ...
                new StkTransferUpdate().addEntry(dataConnection, detail.get(0).getRef_no());
