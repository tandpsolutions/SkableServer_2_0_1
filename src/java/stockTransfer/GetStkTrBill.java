 ...
 * @author bhaumik
 */
public class GetStkTrBill extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dataConnection != null) {
            try {
                String sql = "SELECT v.REF_NO,v.from_loc,v.to_loc,v.V_DATE,t.TAG_NO,t.sr_cd,s.SR_NAME,t.IMEI_NO "
                        + ",t.SERAIL_NO,v1.PUR_TAG_NO,1 AS QTY FROM stktrfhd v LEFT JOIN stktrfdt  v1 ON v.REF_NO = v1.REF_NO "
