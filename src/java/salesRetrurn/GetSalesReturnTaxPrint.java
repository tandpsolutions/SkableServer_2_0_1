 ...
 * @author bhaumik
 */
public class GetSalesReturnTaxPrint extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dataConnection != null) {
            try {
                ...
                String sql = "SELECT t.tax_name,SUM(v1.BASIC_AMT) AS basic,SUM(v1.TAX_AMT) AS tax,SUM(v1.ADD_TAX_AMT) AS add_tax FROM SRHD v LEFT JOIN SRDT v1 ON v.REF_NO=v1.REF_NO "
