 ...
 * @author bhaumik
 */
public class GetContraVoucher extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dataConnection != null) {
            try {
                String sql = "select c1.AC_CD,c.REF_NO,VDATE,a.FNAME,c1.AMT,c1.PART from CONTRAHD c left join CONTRADT c1 on c.REF_NO=c1.REF_NO"
