 ...
 * @author bhaumik
 */
public class GetPurchaseReturnTaxPrint extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dataConnection != null) {
            try {
                ...
                String sql = "SELECT t.tax_name,SUM(v1.BASIC_AMT) AS basic,SUM(v1.TAX_AMT) AS tax,SUM(v1.ADD_TAX_AMT) AS add_tax FROM PRHD v LEFT JOIN PRDT v1 ON v.REF_NO=v1.REF_NO "
