 ...
 * @author bhaumik
 */
public class DeletePurchaseReturn extends HttpServlet {
    ...
    private JsonObject saveVoucher(String ref_no) {
        ...
        if (dataConnection != null) {
            try {
                ...
                sql = "update PRHD set is_del = 1 where ref_no='" + ref_no + "'";
                pstLocal = dataConnection.prepareStatement(sql);
                pstLocal.executeUpdate();

                new PurchaseReturnUpdate().deleteEntry(dataConnection, ref_no);
