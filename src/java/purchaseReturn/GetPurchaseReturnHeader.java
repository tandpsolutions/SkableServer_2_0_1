 ...
 * @author bhaumik
 */
public class GetPurchaseReturnHeader extends HttpServlet {
        ...
        if (dataConnection != null) {
            try {
                String sql = "select l.ac_Cd,l.REF_NO,l.INV_NO,l.V_TYPE,concat(a.FNAME,' ',a.MNAME,' ',a.LNAME) as ac_name,l.V_DATE,l.NET_AMT,"
                        ...
                        + " from PRHD l left join ACNTMST a on l.AC_CD=a.AC_CD left join payment p on l.ref_no=p.ref_no where v_date>=? and v_date<=? "
