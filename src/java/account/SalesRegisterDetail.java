 ...
 * @author bhaumik
 */
public class SalesRegisterDetail extends HttpServlet {
        ...
        if (dataConnection != null) {
            try {
                ...
                while (viewDataRs.next()) {
                    ...
                    object.addProperty("buy_back_model", lb.getSR_CD(dataConnection, viewDataRs.getString("buy_back_model"), "N"));
