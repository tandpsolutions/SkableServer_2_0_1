 ...
 * @author bhaumik
 */
public class AverageSalesReport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dataConnection != null) {
            try {
                String sql = " SELECT b.BRAND_NAME,v.branch_cd,MODEL_NAME,COUNT(t.tag_no) as pcs,SUM(SALE_RATE) AS profit,SUM(SALE_RATE)/COUNT(t.tag_no) AS AVG FROM tag t LEFT JOIN  SERIESMST s ON t.sr_cd=s.sr_cd \n"
